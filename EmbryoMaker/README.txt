***************************************************************************************************
THE EMBRYOMAKER SOFTWARE INCLUDES THIRD PARTY SOURCE CODE FROM THE F03GL PROJECT 
...
Linux x86-64 binaries are provided for both EmbryoMaker and NetworkMaker in the bin/ directory.
...
Linux:
  ...
  Run the compile_EmbryoMaker.sh script
  ...
  IF an ERROR occurs at compilation time complaining about the size of the idum vector, THEN compile with the compile_EmbryoMaker.old.sh instead
