...
! METAPARAMETERS
character*8, public, parameter ::version="18-4-15"   !CHECK MANUALLY date of this version of the code  previous explicit version="26-8-14" !>>> Is 18-4-15  
...
integer,public, parameter      ::nfu=25              !CHECK MANUALLY number of basic forces ! >>> Is 18-4-15
...
integer, public                ::idum(12),idumoriginal(12)  ! 12 is simply because it is the minim required for the intrinsic f90 random_number
...
type(nod), public, allocatable :: node(:),ulte(:),nodeo(:),nodeoo(:) ! Is 14-3-15 notice nodeo saves the initial conditions and for the new nodes Is 25-5-13
