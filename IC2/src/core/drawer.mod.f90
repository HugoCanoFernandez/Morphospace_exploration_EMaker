...
!!print *,i,node(i)%altre,node(i)%tipus
  ...
  if(custom_colorselection==colorselection)then
    ...
    case(35) ; mine=0;maxe=1
               !mine=minval(node(:nd)%bor) ; maxe=maxval(node(:nd)%bor) 
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  if(custom_arrowselection==arrowselection)then
    ...
    case(35) ; amine=0;amaxe=1
               !amine=minval(node(:nd)%bor) ; amaxe=maxval(node(:nd)%bor) 
    !case(36) ; if (chogen==0) then
    !           chogen=1
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  if(custom_sphereselection==sphereselection)then
    ...
    case(35) ; smine=0;smaxe=1
               !smine=minval(node(:nd)%bor) ; smaxe=maxval(node(:nd)%bor) 
    !case(36) ; if (chogen==0) then
    !           chogen=1
...
case(34); node(nodetarget)%bor=tempnod%bor
end select
...
case(35)
         print*,"The ",nodeparams(selection)," of the node is", node(nodeindex)%bor
	 print*,"Please give new marge for the selected node"
         read(*,*) temp
         node(nodeindex)%bor=temp
end select
